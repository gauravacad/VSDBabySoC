...
$ iverilog -o ~/vsd/VSDBabySoC/output/pre_synth_sim/pre_synth_sim.out -DPRE_SYNTH_SIM -I ~/vsd/VSDBabySoC/src/include -I ~/vsd/VSDBabySoC/src/module ~/vsd/VSDBabySoC/src/module/testbench.v
```  
